    ...
    c.setOption({
      ...
      series: [
        ...
        },
        {
          ...
          smooth: true, itemStyle: { color: '#C9A24E' }, lineStyle: { width: 3 },
        },
      ],
    }, true);
