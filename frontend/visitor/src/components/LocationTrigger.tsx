...
const s: Record<string, React.CSSProperties> = {
  ...
  card: {
    ...
    width: '90%',
    textAlign: 'center',
    boxShadow: '0 12px 40px rgba(74,48,40,0.2)',
    animation: 'slideUp 0.3s ease-out',
  },
  icon: { fontSize: 40, marginBottom: 10 },
  title: { fontSize: 20, fontWeight: 700, color: '#4A3028', marginBottom: 4 },
  subtitle: { fontSize: 13, color: '#8B7355', marginBottom: 12 },
  question: { fontSize: 15, color: '#4A3028', marginBottom: 20 },
  buttons: { display: 'flex', gap: 12, justifyContent: 'center' },
  btnYes: {
    flex: 1, padding: '12px 0', borderRadius: 24,
    border: 'none', background: 'linear-gradient(135deg, #C9A24E, #8B6914)',
    color: '#fff', fontSize: 15, fontWeight: 700, cursor: 'pointer',
    boxShadow: '0 4px 14px rgba(184,134,11,0.35)',
  },
  btnNo: {
    flex: 1, padding: '12px 0', borderRadius: 24,
    border: '1px solid #E0D3C0', background: '#FFF9ED',
