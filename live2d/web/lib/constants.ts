...
export const SENTIO_CHARACTER_FREE_MODELS: string[] = ["HaruGreeter", "Haru", "Kei", "Chitose", "Epsilon", "Hibiki", "Hiyori", "Izumi", "Mao", "Rice", "Shizuku", "Tsumiki", "xiaomonk"]
export const SENTIO_CHARACTER_DEFAULT = "xiaomonk"
